$(document).ready(function(){
    ...
    for (let movie in movies) {
        if (i === 1) {
            $("#1").append('<img class="poster" src=' + movies[movie] + '>');
            i = i + 1;
        }
        else if (i === 2) {
            $("#2").append('<img class="poster" src=' + movies[movie] + '>');
            i = i + 1;
        }
        else if (i === 3) {
            $("#3").append('<img class="poster" src=' + movies[movie] + '>');
            i = i + 1;
        }
        else if (i === 4) {
            $("#4").append('<img class="poster" src=' + movies[movie] + '>');
            i = i + 1;
        }
        else if (i === 5) {
            $("#5").append('<img class="poster" src=' + movies[movie] + '>');
            i = i + 1;
        }
        else if (i === 6) {
            $("#6").append('<img class="poster" src=' + movies[movie] + '>');
            i = 1;
        }
    }
});