let database = {
    ...
    'I Am Legend': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': 'https://mediaphiles.files.wordpress.com/2014/10/i-am-legend-movie.jpg', 'uv': true},
    'I, Robot': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': 'https://fanart.tv/fanart/movies/2048/movieposter/i-robot-52175adf03786.jpg', 'uv': true},
    'Ice Age': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': 'http://www.cartoonswallpapers.net/wallpapers/ice-age-poster-widescreen-background-nexus-6.jpg', 'uv': false},
    'Inception': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': true, 'bluray': true, 'url': 'http://1.bp.blogspot.com/_DIDBbFGlCg8/TP4tCo1dlkI/AAAAAAAABQY/TzdwMZbm0cs/s1600/inception-poster.jpg', 'uv': true},
    'Indiana Jones: Raiders of the Lost Ark': {'ma': false, 'uhd': false, 'onlyon': true, 'dvd': false, 'bluray': true, 'url': 'http://3.bp.blogspot.com/-JGFdIlETgQc/UX2HHNHvjrI/AAAAAAAAAF4/wSMMdJlCCQY/s1600/indiana-jones-and-the-raiders-of-the-lost-ark-1981.jpg', 'uv': false},
    'Insurgent': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': 'http://www.movienewz.com/img/gallery/insurgent/posters/insurgent_movie_poster_3.jpg', 'uv': true},
    'Iron Man': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': 'http://4.bp.blogspot.com/_U-_MB3ct83I/S6pL1KH_aHI/AAAAAAAAFI4/xAg9nivP8Bs/s1600/hr_iron_man_poster1.jpg', 'uv': false},
    'Iron Man 2': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': true, 'url': 'https://fanart.tv/fanart/movies/10138/movieposter/iron-man-2-56be8ffe467c2.jpg', 'uv': false},

    'Jack Reacher': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': true, 'url': 'https://www.newdvdreleasedates.com/images/posters/large/jack-reacher-2012-06.jpg', 'uv': true},
    'Jack Ryan: Shadow Recruit': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': true, 'url': 'https://www.newdvdreleasedates.com/images/posters/large/jack-ryan-shadow-recruit-2014-10.jpg', 'uv': true},
    'Jason Bourne': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': 'https://fanart.tv/fanart/movies/324668/movieposter/jason-bourne-579dedb2659f8.jpg', 'uv': true},
    'Jimmy Neutron Boy Genius': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': 'https://fanart.tv/fanart/movies/12589/movieposter/jimmy-neutron-boy-genius-56c645f24f009.jpg', 'uv': true},
    'Jumper': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': 'https://image.tmdb.org/t/p/original/3pPZ9JhNz3VMmASVir5SMHvTDUU.jpg', 'uv': true},
    'Jurassic Park': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': 'http://img.moviepostershop.com/jurassic-park-movie-poster-1992-1020141477.jpg', 'uv': true},
    'Jurassic World': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': 'https://fanart.tv/fanart/movies/135397/movieposter/jurassic-world-56db2daf2ec0d.jpg', 'uv': false},
    'Justice League': {'ma': true, 'uhd': true, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': 'https://www.slashfilm.com/wp/wp-content/images/2017-bestposter-justiceleague.jpg', 'uv': false},
    'Justice League: Crisis on Two Earths': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': 'http://www.comixbrew.net/wp-content/uploads/2013/10/CrisisOnTwoEarths.jpg', 'uv': false},
    'Justice League: Doom': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': 'https://thanley.files.wordpress.com/2012/03/jldoomcover.jpg', 'uv': false},
    ...
    'Lord of the Rings: The Fellowship of the Ring': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'Lord of the Rings: The Two Towers': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'Lord of the Rings: The Return of the King': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},

    'Madagascar': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'Man on a Ledge': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'Man of Steel': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': true, 'bluray': true, 'url': '', 'uv': true},
    'Megamind': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    ...
    'Men in Black 3': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': true, 'url': '', 'uv': false},
    'Minions': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': true, 'bluray': true, 'url': '', 'uv': true},
    'Mission Impossible': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'Mission Impossible 3': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'Mission Impossible Ghost Protocol': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': true, 'bluray': true, 'url': '', 'uv': true},
    'Mission Impossible Rogue Nation': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': true, 'bluray': true, 'url': '', 'uv': true},
    ...
    'Monsters vs Aliens': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'Mr Peabody and Sherman': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'Mr. & Mrs. Smith': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'Mulan': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},

    'Nephi and the Brass Plates': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': true, 'bluray': false, 'url': '', 'uv': false},
    'Night at the Museum': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'Now You See Me': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': true, 'bluray': true, 'url': '', 'uv': true},
    'Now You See Me 2': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    ...
    'Percy Jackson and the Olympians: The Lightning Thief': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'Percy Jackson and the Olympians: The Sea of Monsters': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'Peter Pan': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'Phantom of the Opera': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': true, 'bluray': false, 'url': '', 'uv': false},
    ...
    'Ready Player One': {'ma': true, 'uhd': true, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    ...
    'Rise of the Guardians': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    ...
    'Superman: The Movie': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'Superman: Brainiac Attacks': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    ...
    'Star Wars 7- The Force Awakens': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': true, 'bluray': true, 'url': '', 'uv': false},
    'Sherlock Holmes A Game Of Shadows': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'Sherlock Holmes': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'Snow White and the 7 Dwarves': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'School House Rock': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': true, 'bluray': false, 'url': '', 'uv': false},
    ...
    'Superman Doomsday': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'Superman Returns': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'Split': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'Star Trek Into Darkness': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'Spider-Man 2': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'Spectre': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': true, 'url': '', 'uv': true},
    ...
    'The Hunger Games': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'The Bourne Identity': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': true, 'url': '', 'uv': true},
    'The Bourne Supremacy': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': true, 'url': '', 'uv': true},
    'The Greatest Showman': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'The Polar Express': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': true, 'bluray': false, 'url': '', 'uv': false},
    'The Dark Knight Returns Deluxe Edition (part 1 + 2)': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'The Iron Giant (Signiture Edition)': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'The Italian Job': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'The Last Witch Hunter': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'Taken 2': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': true, 'url': '', 'uv': true},
    'The Maze Runner': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'The Lego Movie': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'The Great Mouse Detective': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    ...
    'The Incredibles': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'The Da Vinci Code': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'Tommorrow Never Dies': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'The Amazing Spiderman 2': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'The Bourne Ultimatum': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': true, 'url': '', 'uv': true},
    'The Martian': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': true, 'url': '', 'uv': true},
    'The Amazing Spiderman': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': true, 'bluray': true, 'url': '', 'uv': true},
    'The Peanuts Movie': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'The Book of Life': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    ...
    'The Lego Batman Movie': {'ma': true, 'uhd': true, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'The World is Not Enough': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'Transformers 3 Dark of the Moon': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'The Zookeeper\s Wife': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'Thor': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'The Prince of Egypt': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'The Fault in our Stars': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'The Pursuit of Happyness': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'The Imitation Game': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'The Blind Side': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'Transformers 2 Revenge of the Fallen': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'The Hunt for Red October': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'The Cold Light of Day': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'Thor 2': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'The Bourne Legacy': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': true, 'url': '', 'uv': true},
    ...
    'We Bought A Zoo': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'Warm Bodies': {'ma': false, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'Wallace and Grommit The Curse of the Were-Rabbit': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'Wonder Woman': {'ma': true, 'uhd': true, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'Wrath of the Titans': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'Wreck It Ralph': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},

    'X-Men: Apocalypse': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'X-Men Origins Wolverine': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
    'X-Men: Days of Future Past': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': false},
    'X-Men: First Class': {'ma': true, 'uhd': false, 'onlyon': false, 'dvd': false, 'bluray': false, 'url': '', 'uv': true},
